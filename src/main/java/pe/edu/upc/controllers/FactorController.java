...
public class FactorController {
	...
	private List<TipoFactor> listaTipoFactores;
...
//eliminar
	...
	public void delete(Factor fac) {
		try {

			fService.delete(fac.getIdFactor());
			//tfService.delete(tpf.getIdTipoFactor());||, TipoFactor tpf
			this.list();
		} catch (Exception e) {
			System.out.println("Error al eliminar en elcontroller factor");
		}
	}
